...
public class AbstractHero : IHero, IComparable<AbstractHero>
{
    ...
    public ICollection<IItem> Items
    {
        get
        {
            Type typeItem = typeof(HeroInventory);

            var field = typeItem.GetFields(BindingFlags.Instance | BindingFlags.NonPublic)
                .FirstOrDefault(x => x.GetCustomAttribute(typeof(ItemAttribute)) != null);
